...
void GameRegistry::LoadResources()
{
    LoadShaders();
    SpawnLight();
    SpawnMap(20, 20);
...
void GameRegistry::SpawnMap(uint32_t aWidth, uint32_t aHeight)
{
    auto [diff, dLoaded] =
...
void GameRegistry::SpawnPlayerAndCamera()
{
    auto player = create();
