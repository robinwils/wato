...
void ServerRegistry::LoadResources()
{
    LoadShaders();
    SpawnLight();
    SpawnMap(20, 20);
...
void ServerRegistry::LoadShaders()
{
...
void ServerRegistry::SpawnMap(uint32_t aWidth, uint32_t aHeight)
{
    auto [diff, dLoaded] =
...
void ServerRegistry::SpawnLight()
{
    auto light = create();
...
void ServerRegistry::LoadModels()
{
...
void ServerRegistry::SpawnPlayerAndCamera()
{
    auto player = create();
